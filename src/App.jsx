...
const DAYS = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: "3:30", cat: "personal", task: "🎯 Target run — paper towels, hair gel" },
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: "7:15", cat: "wellness", task: "Meditation + journaling" },
      { t: "7:30", cat: "recovery", task: "Morning stretch (15-20 min)" },
      { t: "8:00", cat: "health", task: "🩺 Doctor: Physical + blood work appointment" },
      { t: "9:30", cat: "fitness", task: "Gym: Heavy legs — squats, deadlifts, hip thrusts (60 min)" },
      { t: "10:45", cat: "personal", task: "Breakfast" },
      { t: "11:30", cat: "admin", task: "📞 Geico claim — call and follow up" },
      { t: "12:00 PM", cat: "job", task: "📞 Quick Connect A&R: Jon/Brandon (Zoom)" },
      { t: "12:30", cat: "personal", task: "Lunch" },
      { t: "1:00", cat: "heloc", task: "HELOC: Final push — where are we? Decision needed" },
      { t: "2:00", cat: "job", task: "📞 Meeting with Frances Augustine" },
      { t: "3:00", cat: "job", task: "Interview prep — review McKesson role, talking points, STAR examples" },
  ...
  // ═══════════════════════════════════════════
  {
    ...
    blocks: [
      ...
      { t: "1:30", cat: "job", task: "Apply to 3-5 roles" },
      { t: "2:30", cat: "admin", task: "📧 Email HR" },
      { t: "3:00", cat: "admin", task: "Admin: Final consumer claims sweep (anything remaining)" },
      { t: "4:00", cat: "recovery", task: "🏊 Pool: Relax + swim — last day before rain (90 min)" },
      { t: "5:30", cat: "fitness", task: "🧘 ClassPass: Evening yoga" },
  ...
  {
    date: "Wed, Mar 4", week: 2, tag: "Deep Job Search + Best Buy",
    theme: "Research, outreach, applications. Best Buy appt + cancel. Financial planning.",
    blocks: [
      { t: "7:00 AM", cat: "sleep", task: "Wake up — sunlight, hydrate" },
      { t: "7:15", cat: "wellness", task: "Meditation + journaling" },
      { t: "7:30", cat: "recovery", task: "Morning stretch (15-20 min)" },
      ...
      { t: "11:30", cat: "personal", task: "🏪 Best Buy appointment + cancel Best Buy membership/service" },
      { t: "12:30", cat: "personal", task: "Lunch" },
      { t: "1:15", cat: "job", task: "Apply to 5 roles + cold outreach: 5 contacts at target companies" },
      { t: "2:30", cat: "heloc", task: "HELOC: Status check. Employment verification window closing" },
      { t: "3:00", cat: "legal", task: "BoA: Push attorney engagement. File CFPB rebuttal if ready" },
      { t: "3:30", cat: "fitness", task: "Outdoor walk (30 min)" },
      { t: "4:15", cat: "admin", task: "💰 Financial planning models — build out or review" },
      { t: "6:00", cat: "personal", task: "Dinner" },
  ...
  },
  {
    ...
    theme: "Network hard. Interview prep. Website/planner work. Evening Pilates. TRT: hCG + Anastrozole today.",
    blocks: [
      { t: "7:00 AM", cat: "sleep", task: "Wake up — sunlight, hydrate" },
      { t: "7:15", cat: "wellness", task: "Meditation + journaling" },
      { t: "7:30", cat: "recovery", task: "Morning stretch (15-20 min)" },
      ...
      { t: "2:30", cat: "personal", task: "🌐 Website plan + goals tracker/planner updates" },
  ...
  {
    date: "Sat, Mar 7", week: 2, tag: "Recovery + House Projects",
    theme: "Massage + IR sauna. Patio/yardwork. Plan shelves + shades upstairs. Social.",
    blocks: [
      { t: "8:00 AM", cat: "sleep", task: "Wake up naturally (by 8:00)" },
      { t: "8:15", cat: "wellness", task: "Meditation + gratitude journal" },
      ...
      { t: "11:30", cat: "fitness", task: "Outdoor: cycling, hike, or long walk (60-90 min)" },
      { t: "1:00 PM", cat: "personal", task: "Lunch" },
      { t: "1:45", cat: "personal", task: "🧹 Clean patio + yardwork + paperwork" },
      { t: "3:00", cat: "personal", task: "📐 Plan shelves + shades upstairs" },
      { t: "3:45", cat: "personal", task: "Grocery + meal prep" },
      { t: "5:00", cat: "recovery", task: "🧖 IR sauna (30-45 min)" },
